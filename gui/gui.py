...
def replicaset():
    ...
    primary_data=student_main.get_student_from_replicaset(primary_port)
    secendary_data=student_main.get_student_from_replicaset(secendary_port)
